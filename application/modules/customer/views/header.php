  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <?php if ($params['page'] = 'Profile') { ?>
          <a href="<?php echo site_url('customer/profile'); ?>" class="d-block active"><?php echo get_user_name(); ?></a>
            </a>
              <?php } else { ?>
      ...
      <nav class="mt-2">
        ...
        <?php if ($params['page'] = 'Dashboard') { ?>
          ...
          <li class="nav-item">
        <?php if ($params['page'] = 'order') { ?>
            <a href="<?php echo site_url('customer/orders'); ?>" class="nav-link active">
              <?php } else { ?>
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('customer/payments'); ?>" class="nav-link active">
          ...
          <li class="nav-item">
        <?php if ($params['page'] = 'Review') { ?>>
            <a href="<?php echo site_url('customer/reviews'); ?>" class="nav-link active">
              <?php } else { ?>
