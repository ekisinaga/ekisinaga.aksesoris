...
?><!DOCTYPE html>
 ...
 <body class="@yield('sidebar_type')">
     ...
     <div class="scrollbar-inner">
       ...
       <div class="sidenav-header d-flex align-items-center">
         <a class="navbar-brand" href="<?php echo base_url(); ?>">
           <img src="<?php echo get_admin_image(); ?>" width="50px" height="75px" style="margin:auto;" class="navbar-brand-img" alt="Logo <?php echo get_store_name(); ?>">
         </a>
         <div class="ml-auto">
           <!-- Sidenav toggler -->
   ...
   <div class="main-content" id="panel">
     <!-- Topnav -->
     <nav class="navbar navbar-top navbar-expand navbar-dark bg-krisna border-bottom">
