...
class M_order extends CI_Model {
    ...
    public function count_all_orders($id)
    {
        return $this->db->where('id_kurir', $id)->get('orders')->num_rows();
    }
    public function count_process_order($id)
    {
    ...
    public function set_kurir($kurir, $order)
    {
        return $this->db->where('id', $order)->update('orders', array('id_kurir' => $kurir));
    }
